...
<div align="center">
  <img src="images/banner2.svg" alt="banner" width="100%"/>
</div>

## 👨‍💻 About Me

<img align="right" width="220" src="./images/write.jpeg" alt="Developer Image">

I’m **Saadat Ali**, a **Software Engineer** focused on designing and developing scalable backend systems and clean, efficient web apps.  
I love solving real-world problems using technology that balances performance, security, and simplicity.

- 🧠 Specialized in **Node.js**, **Next.js**, and **React**
- ⚙️ Experienced in **API design**, **microservices**, and **system architecture**
- 🧩 Skilled in **AWS**, **Docker**, and **CI/CD pipelines**
- 📱 Occasionally build cross-platform apps with **Flutter**
- 🤖 Interested in **AI-based applications** and **automation**
- ⚡ Always refining developer workflows for speed and maintainability

---

## 🧰 Tech Stack

**Backend:** Node.js | Express.js | Nest.js | MongoDB | PostgreSQL | REST | GraphQL  
**Frontend:** React.js | Next.js | Redux | Tailwind CSS  
**Mobile:** Flutter | Kotlin  
**DevOps:** Docker | Nginx | PM2 | GitHub Actions | CI/CD  
**Cloud & Infra:** AWS EC2 | S3 | RDS | CloudFront  
**Other Tools:** Stripe | Shopify API | OpenAI API | Rollup | Webpack  
...
[![Saadat's GitHub stats](https://github-readme-stats.vercel.app/api?username=saadat-ali-awan&show_icons=true&count_private=true&theme=react)](https://github.com/saadat-ali-awan)

[![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=saadat-ali-awan&layout=compact&theme=react&langs_count=10)](https://github.com/saadat-ali-awan)
...
Last Updated: Wednesday, September 16th, 2026, 12:43:35 PM
<!--RECENT_ACTIVITY:last_update_end-->

---

### 📌 Current Focus
Building **scalable backend systems**, experimenting with **AI integrations**, and refining **developer tooling** for faster, safer deployments.
